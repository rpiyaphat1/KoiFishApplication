        ...
        <div className="flex-1 flex flex-col justify-center items-center p-8 bg-[#020617] relative z-10 shadow-[-40px_0_80px_rgba(0,0,0,0.8)]">
          <div className="w-full max-w-[400px] space-y-10 animate-in fade-in slide-in-from-right-10 duration-700">
            ...
            <div className="grid grid-cols-2 gap-4">
              <button onClick={() => handleSocialLogin('google')} className="flex items-center justify-center gap-3 py-4 border border-slate-800 rounded-2xl hover:bg-white/5 transition-all duration-300 hover:scale-105 hover:-rotate-2 active:scale-95 font-black text-xs text-white italic shadow-lg">
                <Chrome size={20} className="text-red-500" /> GOOGLE
              </button>
              <button onClick={() => handleSocialLogin('facebook')} className="flex items-center justify-center gap-3 py-4 bg-[#1877F2] text-white rounded-2xl hover:opacity-90 transition-all duration-300 hover:scale-105 hover:rotate-2 active:scale-95 font-black text-xs tracking-widest text-white italic shadow-lg">
